...
% LaTeX Template
% with National Cheng Kung University logo
% Version 1.0 (10/7/19)
%
% Based on:
...
% https://github.com/rudvfaden/University-of-Copenhagen-poster
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{times} % Use the times font # times
...
\vspace{9.5cm}
\Huge \color{ko} \textbf{Unnecessarily Complicated Research Title} \color{Black}\\[0.8cm] % Title
\huge\textit{An Exploration of Complexity}\\[1cm] % Subtitle
\Large \textbf{Lin Chun-Yu}\\[0.5cm] % Author(s)
\Large College of Social Science\\[0.4cm]   % University/organization
...
\vspace{9.5cm}
\flushright
\color{ko} % DarkSlateGray
\Large \textbf{Contact Information:}\\
No. 1, Dasyue Road,\\
East District, Tainan.\\[1cm]
Phone: +886 (06)2757-575 \#56512\\ % Phone number
Email: \texttt{cyjlin@ncku.edu.tw}% Email address
\end{minipage}
...
\color{ko} % Defined color for the abstract
...
\color{DarkSlateGray} % DarkSlateGray color for the introduction
...
\color{ko} % SaddleBrown/DarkSlateGray or your preferred color for the conclusions to make them stand out
...
%----------------------------------------------------------------------------------------
\color{DarkSlateGray} % DarkSlateGray for the rest of the document
